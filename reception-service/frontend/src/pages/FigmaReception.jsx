...
import "../styles/figmaReception.css";
...
const AddAppointmentDialog = ({ staffList, onAddAppointment }) => {
    const initialState = {
        email: "",
        services: "",
        date: "",
    ...
    return (
        <>
            <button className="fr-btn-primary" onClick={() => setOpen(true)}>
                Add Appointment
            </button>
            {open && (
                    ...
                    <div className="fr-modal">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="fr-form-actions">
                                <button type="button" className="fr-btn-secondary" onClick={() => setOpen(false)}>
                                    Cancel
                                </button>
...
export default function FigmaReception() {
        ...
        <div className="figma-reception">
            <header>
                <div className="fr-container" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    ...
                    <AddAppointmentDialog staffList={mockStaff} onAddAppointment={handleAddAppointment} />
                </div>
            </header>
